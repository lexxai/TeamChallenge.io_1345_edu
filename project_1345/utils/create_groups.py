...
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "project_1345.settings")
django.setup()
...
GROUP_PERMISSIONS = {
    ...
    "managers": {
        "default": READ_PERMISSIONS,
        "product.product": WRITE_PERMISSIONS,
        "product.productimage": WRITE_PERMISSIONS,
        "category.category": WRITE_PERMISSIONS,
        "category.categoryschema": WRITE_PERMISSIONS,
        "storage.storage": WRITE_PERMISSIONS,
    },
}
